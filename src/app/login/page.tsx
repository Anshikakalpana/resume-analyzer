...
export default function Login() {
  return (
    <div className="bg-gradient-to-br from-gray-900 to-black min-h-screen flex items-center justify-center p-4">
      <div className="w-full max-w-md bg-gray-800 rounded-2xl shadow-2xl p-6 sm:p-10 flex flex-col gap-6">
        
       
        <h1 className="text-2xl sm:text-3xl font-bold text-center text-white">Login</h1>

    
        <div className="flex flex-col gap-2">
          <label className="text-sm text-gray-300">Email</label>
          <input
            className="h-11 sm:h-12 px-3 sm:px-4 rounded-xl bg-gray-700 text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-indigo-500 transition"
        ...
        <button className="h-11 sm:h-12 bg-indigo-600 hover:bg-indigo-700 rounded-xl font-semibold text-white shadow-md transition">
          SUBMIT
        </button>
...
<form action={async () => {
  ...
  <div className="flex flex-col sm:flex-row gap-4 font-semibold text-white" >
 <button className="flex items-center justify-center gap-2 border border-gray-500 h-11 rounded-xl flex-1 hover:bg-gray-700 transition">
            <GitHub className="size-5" /> GitHub
          </button>
          <button className="flex items-center justify-center gap-2 border border-gray-500 h-11 rounded-xl flex-1 hover:bg-gray-700 transition">
            <Google className="size-5" /> Google
          </button>   
